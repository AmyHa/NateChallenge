...
class ProductsTests: XCTestCase {
    ...
    func test_init_setsID() {
        let product = Product(id: "123", title: "", images: [String](), url: "", merchant: "")
        
        XCTAssertEqual(product.id, "123")
    }
    
    func test_init_setsTitle() {
        let product = Product(id: "123", title: "Island Punch Bath Bomb", images: [String](), url: "", merchant: "")

        XCTAssertEqual(product.title, "Island Punch Bath Bomb")
    }

    func test_init_setsImages() {
        let product = Product(id: "123", title: "", images: ["https://www.oldwhalingcompany.com/mm5/graphics/00000001/Island-Punch-Bath-Bomb-POW-960.png"], url: "", merchant: "")
    ...
    func test_init_setsMerchant() {
        let product = Product(id: "123", title: "Island Punch Bath Bomb", images: [String](), url: "", merchant: "www.oldwhalingcompany.com")
    ...
    func test_decodeObject_successfulDecodeProducts() throws {
        ...
        XCTAssertEqual(data.products[0].url, "a-url.com")
        ...
        XCTAssertEqual(data.products[1].url, "a-url.com")
